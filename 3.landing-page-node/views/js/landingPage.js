function validateEmail(e) {
    ...
    axios.post('http://homemade.delivery.com:8004', {
        ...
        .catch(function(error) {
            document.getElementById("invalid").innerHTML = "Invalid email address/phone number. please try again";
...
function onSort(e, type) {
    flag = (!flag);
    console.log(flag);
    axios.get(`http://homemade.delivery.com:8003/admin?sorted_column=${type}&isDesc=${flag ? 'true' : 'false'}`).then(function(response) {
